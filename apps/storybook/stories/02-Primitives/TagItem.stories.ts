...
const meta = {
  ...
  render: args => ({
    ...
    template: `<TagItem v-bind="args"><template #icon>${starIcon}</template>Label</TagItem>`,
  }),
...
export const WithoutIcon: Story = {
  render: () => ({
    components: { TagItem },
    template: `<TagItem variant="blue">No icon</TagItem>`,
  }),
};
  ...
  render: () => ({
    ...
    template: `
      <div class="flex flex-wrap items-center gap-2">
        <TagItem variant="blue"><template #icon>${starIcon}</template>Blue</TagItem>
        <TagItem variant="green"><template #icon>${checkIcon}</template>Green</TagItem>
        <TagItem variant="red"><template #icon>${circleIcon}</template>Red</TagItem>
        <TagItem variant="yellow"><template #icon>${starIcon}</template>Yellow</TagItem>
        <TagItem variant="gray"><template #icon>${circleIcon}</template>Gray</TagItem>
      </div>
    `,
  }),
};
