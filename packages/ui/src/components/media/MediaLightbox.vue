      ...
      >
        ...
        >
          ...
          <div
            ...
            class="flex flex-col items-center justify-center p-8 bg-primary rounded-lg"
          >
            <svg class="w-16 h-16 text-muted-foreground/60 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
